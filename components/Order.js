  ...
  return (
    <div className="relative border rounded-md">
        <div className="flex items-center space-x-10 p-5 bg-gray-100 text-sm text-gray-600">
            <div>
                <p className="font-bold text-xs pt-2">ORDER PLACED</p>
                <p>{moment.unix(timestamp).format("DD MM YYYY")}</p>
            </div>

            <div>
                <p className="text-xs font-bold pt-2">TOTAL</p>
                <p>
            ...
            <p className="absolute top-2 right-2 w-64 lg:w-80 truncate text-xs whitespace-nowrap">ORDER # {id}</p>
        </div>
